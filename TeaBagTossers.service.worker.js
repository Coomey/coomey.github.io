...
/** @type {string} */
const CACHE_VERSION = '1740316005|2982998354';
/** @type {string} */
const CACHE_PREFIX = 'TeaBagTossers-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'TeaBagTossers.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["TeaBagTossers.html","TeaBagTossers.js","TeaBagTossers.offline.html","TeaBagTossers.worker.js","TeaBagTossers.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["TeaBagTossers.wasm","TeaBagTossers.pck"];
